...
public class InitiationActivity extends Application {
    ...
    private String [] spinner_walk_array = {"где собака будет гулять чаще всего:",
            "минимальные условия для выгула", "ограниченный выгул в городской черте", "лес или лесопарк", "регулярные выезды на охоту, трекинг, спорт", "неограниченно на своей территории"};
    ...
    MyBucket hair = new MyBucket("Длинна шерсти короткая (1), длинная (2), жесткая (3), любая (0)", 0); //если 0 то параметр SQL запроса принимает "%", 1 "short", 2 "long"
